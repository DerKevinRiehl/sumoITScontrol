# sumoITScontrol/control/ramp_metering/HERO.py
...
class HERO:
    def __init__(self, params, coordination_group, alinea_controllers):
        ...
        self.log = {
            "time": [],
            "ramps": {}  # ramp_id -> dict of timeseries
        }
    ...
    def minimum_queue_control(self, slave_ctrl):
        ...
        N_hat_m = np.nanmean(ramp._get_queue_state("getLastIntervalMaxJamLengthInMeters"))
        ...
        green_fraction = np.clip(green_fraction, slave_ctrl.params["min_rate"], slave_ctrl.params["max_rate"])
