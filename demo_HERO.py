...
for alinea_controller_name in controller.alinea:
    ...
    plt.step(np.asarray(alinea_controller.measurement_data["metering_rate"])[:,0],
...
for alinea_controller_name in controller.alinea:
    alinea_controller = controller.alinea[alinea_controller_name]
    plt.step(np.asarray(alinea_controller.measurement_data["metering_occupancy"])[:,0],
...
for alinea_controller_name in controller.alinea:
    alinea_controller = controller.alinea[alinea_controller_name]
    plt.step(np.asarray(alinea_controller.measurement_data["queue_length_m"])[:,0],
